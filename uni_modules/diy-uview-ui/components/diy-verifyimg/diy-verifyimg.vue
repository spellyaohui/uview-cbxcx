	...
	<view class="diy-verify" v-if="initShow" :class="isModal?'diy-verify-modal':''" :id="elid"  @touchmove.stop.prevent="stopMoveHandle" :style="verifyWidthStyle">
		...
		<view class="diy-verify-wrap"  v-if="isShow">
			...
			<view class="diy-verify-verify" v-if="showBottomVerify"  :style="verifyBottomStyle">
				...
				<!-- 手指触摸的滑块 -->
				<view class="diy-verify-verify-touch" :style="verifyTouchStyle" @touchstart="touchstartHandle" 	@touchmove="touchmoveHandle" @touchend="touchendHandle" @mousedown="mousedownHandle">
				</view>
			</view>
		</view>
	</view>
	...
	export default {
		...
		methods: {
			...
			mousedownHandle(e) {
				...
				// 兼容uniapp，PC端e.pageX，H5端e.changedTouches[0].pageX
